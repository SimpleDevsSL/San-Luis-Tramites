...
export interface Guide {
  ...
  paraQuienEs: string
  requisitos: string[]
  requisitosCategorias?: RequisitosCategoria[]
  requisitosAviso?: string
  costoDetalles?: { concepto: string; monto: string }[]
  costo: {
    monto: string
    formasDePago: string[]
  ...
  pasos?: PasoAPaso[]
  trucoPuntano: string
  enlacesOficiales: { label: string; url: string }[]
  fuentes: string
}
...
export const guides: Guide[] = [
  {
    ...
    shortTitle: "CIPE",
    description:
      "La Cedula de Identidad Provincial Electronica es tu documento de identidad provincial. Te explicamos como sacarla paso a paso.",
    lastUpdated: "Enero 2026",
    queEs:
      "El CIPE es la Cedula de Identidad Provincial Electronica de San Luis. Funciona como un complemento de tu DNI y es obligatoria para realizar muchos tramites provinciales.",
    paraQuienEs:
      "Para todas las personas que residen en la provincia de San Luis y necesitan realizar tramites provinciales o acceder a servicios del gobierno provincial.",
    requisitos: [
    ...
    trucoPuntano:
      "Anda temprano, antes de las 8:30. Despues de las 9 la fila crece rapido. Lleva toda la documentacion en una carpeta porque si te falta algo te mandan de vuelta.",
    enlacesOficiales: [
      { label: "Web Oficial \u2013 Sacar turno CIPE", url: "https://tramites.sanluis.gob.ar" },
    ],
    fuentes:
      "Informacion basada en datos publicados en tramites.sanluis.gob.ar al dia Enero 2026.",
  },
  {
    ...
    description:
      "Todo lo que necesitas saber para sacar o renovar tu licencia de conducir en San Luis Capital, sin vueltas.",
    lastUpdated: "Enero 2026",
    queEs:
      "La licencia de conducir es el permiso obligatorio para poder manejar un vehiculo legalmente en la ciudad de San Luis.",
    paraQuienEs:
      "Para cualquier persona con domicilio en San Luis Capital que necesite sacar su licencia por primera vez o renovarla.",
    requisitos: [
    ...
    trucoPuntano:
      "Pedi el PDF con preguntas y respuestas para practicar el teorico. El curso solo no suele ser suficiente.",
    enlacesOficiales: [
    ...
    fuentes:
      "Informacion basada en datos brindados en la Municipalidad de San Luis y sitios oficiales al dia Enero 2026.",
  },
  {
    ...
    description:
      "Como consultar, generar la boleta y pagar el impuesto automotor en la provincia de San Luis.",
    lastUpdated: "Enero 2026",
    queEs:
      "El impuesto automotor es un tributo provincial que pagas anualmente por cada vehiculo registrado a tu nombre en San Luis. Se gestiona a traves de la Direccion Provincial de Rentas.",
    paraQuienEs:
      "Para todos los propietarios de vehiculos (autos, motos, camionetas, etc.) registrados en la provincia de San Luis.",
    requisitos: [
      "DNI del titular",
    ...
    trucoPuntano:
      "Podes generar la boleta y pagar todo desde la web, sin hacer fila. Si pagas antes del primer vencimiento, generalmente hay descuento por pronto pago.",
    enlacesOficiales: [
      { label: "Web Oficial \u2013 Generar boleta automotor", url: "https://rentas.sanluis.gob.ar" },
    ],
    fuentes:
      "Informacion basada en datos publicados en rentas.sanluis.gob.ar al dia Enero 2026.",
  },
  {
    slug: "dosep",
    ...
    shortTitle: "DOSEP",
    description:
      "Guia para afiliarte a DOSEP o gestionar ordenes medicas en la obra social de empleados publicos de San Luis.",
    lastUpdated: "Enero 2026",
    queEs:
      "DOSEP es la obra social de los empleados publicos de la provincia de San Luis. Brinda cobertura medica, odontologica y farmaceutica.",
    paraQuienEs:
      "Para empleados publicos de la provincia de San Luis y sus familiares directos (conyuge e hijos) que quieran afiliarse u obtener ordenes de atencion.",
    requisitos: [
    ...
    trucoPuntano:
      "Muchas ordenes medicas se pueden gestionar online desde el portal de DOSEP. Revisa primero ahi antes de ir personalmente. Si vas presencial, anda antes de las 8.",
    enlacesOficiales: [
      { label: "Web Oficial \u2013 Portal DOSEP", url: "https://www.dosep.sanluis.gob.ar" },
    ],
    fuentes:
      "Informacion basada en datos publicados en dosep.sanluis.gob.ar al dia Enero 2026.",
  },
  {
    ...
    description:
      "Como tramitar el boleto estudiantil gratuito para viajar en colectivo en San Luis siendo estudiante.",
    lastUpdated: "Enero 2026",
    queEs:
      "El Boleto Estudiantil Gratuito es un beneficio provincial que permite a los estudiantes viajar gratis en el transporte publico de colectivos dentro de San Luis.",
    paraQuienEs:
      "Para estudiantes regulares de nivel primario, secundario, terciario y universitario que residan en San Luis y usen el transporte publico.",
    requisitos: [
      "DNI original",
      "CIPE vigente",
    ...
    trucoPuntano:
      "Hacelo ni bien arranca el periodo de inscripcion porque despues hay mucha demanda y se forman filas largas. Tene el certificado de alumno regular listo con anticipacion.",
    enlacesOficiales: [
      { label: "Web Oficial \u2013 Boleto Estudiantil", url: "https://www.sanluis.gob.ar" },
    ],
    fuentes:
      "Informacion basada en datos publicados en sanluis.gob.ar al dia Enero 2026.",
  },
]
